...
class Item_location extends CI_Model
{
	...
	*/
	...
	function adjust_accounting_product_quantity($qty_adjustemnt, $item_id,$location_id)
	{
	  $this->db->set('accounting_product_quantity','accounting_product_quantity+'.$qty_adjustemnt,false);
	  $this->db->where('item_id', $item_id);
	  $this->db->where('location_id', $location_id);
