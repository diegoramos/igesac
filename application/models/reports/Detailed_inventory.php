...
class Detailed_inventory extends Report
{
	...
	public function getData()
	{
		...
		$this->db->select('CONCAT('.$people.'.first_name," ",'.$people.'.last_name) as customer,locations.name as location_name, item_variation_id, inventory.*, items.*, categories.id as category_id,categories.name as category');
