...
class Detailed_transfers extends Report
{
	...
	public function getData()
	{
		...
		$this->db->select('receivings.transfer_to_location_id, locations.name as transfer_from, '.$this->db->escape($transfer_from).' as transfer_to, receiving_id, date(receiving_time) as receiving_date, total_quantity_purchased as items_purchased,total_quantity_received as items_received, CONCAT(employee.first_name," ",employee.last_name) as employee_name, CONCAT(supplier.company_name, " (",people.first_name," ",people.last_name, ")") as supplier_name, subtotal, total, tax, sum(profit) as profit, payment_type, comment', false);
