...
class Closeout extends Report
{
	...
	public function getOutputData()
	{
		...
		$model = $this;
		$model->setParams(array('start_date'=>$start_date, 'end_date' => $end_date, 'sales_total_for_payments' => $sales_totals_for_payments,'export_excel' => $this->params['export_excel']));
	...
	public function getData()
	{
		...
		$return[] = array(lang('reports_average_items_sold_per_transaction'),  to_quantity($sales_row['quantity']/$number_of_sales_transactions));
