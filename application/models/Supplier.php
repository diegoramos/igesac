	...
	*/
	...
	function get_displayable_columns()
	{
		$columns = array(
			...
			'company_name' => 									array('sort_column' => 'company_name','label' => lang('common_company'),'data_function' => 'supplier_name_data_function','format_function' => 'supplier_name_formatter','html' => TRUE),
	...
	{
		return array('person_id','company_name','last_name','first_name','email','phone_number','balance');
	}
	...
	function get_suppliers_not_in_quickbooks_or_modified_since_last_sync()
	{
	...
	function is_supplier_in_quickbooks($accounting_id)
	{
		$this->db->from('suppliers');	
		$this->db->where('suppliers.accounting_id',$accounting_id);
