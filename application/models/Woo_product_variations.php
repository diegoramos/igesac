...
class Woo_product_variations extends MY_Woo
{
	...
	{	
		...
		if(!empty($item_variation['image']))
		{
			...
			$image_data = array('alt' =>$item_variation['image']['alt_text'], 'name' => $item_variation['image']['title'], 'src' => $this->CI->Appfile->get_url_for_file($item_variation['image']['image_id']), 'position' => 0);
