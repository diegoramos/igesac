...
{
	protected $CI;
	protected $woo_store_url;
	protected $woo_api_key;
	protected $woo_api_secret;
	protected $woo_read_chunk_size;
	protected $woo_read_sleep;
	protected $woo_write_chunk_size;
	protected $woo_curl_timeout;
	protected $start_time;
	protected $woo_api_version;
	
	protected $data;
	protected $parameters;
	protected $response;
	
	protected $batch_create_ids;
	protected $batch_update_ids;
	protected $batch_delete_ids;
  ...
  {		
		...
		{			
			...
			if(isset($response_headers['X-WP-TotalPages']) && $response_headers['X-WP-TotalPages']  > $page)
			{
				$page++;
				$send_call=true;
