		...
		<div class="row" id="form">
			...
			<div class="col-md-12">				
				<div class="panel panel-piluku">
					...
					<!--            AQUI VA LOS CAMBIOS NUEVO             -->

						<div class="form-group">	
								<?php echo form_label(lang('sales_invoice').':', 'factura',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label primeral')); ?>
								<div class="col-sm-3 col-md-3 col-lg-3 input-field">
								<?php echo form_input(array(
									'class'=>'form-control form-inps',
									'name'=>'factura[sales_invoice]',
									'id'=>'factura',
									'maxlength'=>'5',
									'value'=>$sunat_num['factura']));?>
								</div>
								<?php echo form_label(lang('sales_bill').':', 'boleta',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label primeral')); ?>
								<div class="col-sm-3 col-md-3 col-lg-3 input-field">
								<?php echo form_input(array(
									'class'=>'form-control form-inps',
									'name'=>'boleta[sales_bill]',
									'id'=>'boleta',
									'maxlength'=>'5',
									'value'=>$sunat_num['boleta']));?>
								</div>
						</div>
						<div class="form-group">	
								<?php echo form_label(lang('sales_quotation').':', 'cotizacion',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label primeral')); ?>
								<div class="col-sm-3 col-md-3 col-lg-3 input-field">
								<?php echo form_input(array(
									'class'=>'form-control form-inps',
									'name'=>'cotizacion[sales_quotation]',
									'id'=>'cotizacion',
									'maxlength'=>'5',
									'value'=>$sunat_num['cotizacion']));?>
								</div>
								<?php echo form_label(lang('order_purchase').':', 'odencompra',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label primeral')); ?>
								<div class="col-sm-3 col-md-3 col-lg-3 input-field">
								<?php echo form_input(array(
									'class'=>'form-control form-inps',
									'name'=>'odencompra[order_purchase]',
									'id'=>'odencompra',
									'maxlength'=>'5',
									'value'=>$sunat_num['odencompra']));?>
								</div>
						</div>
						<div class="form-group">	
								<?php echo form_label(lang('sales_receipt').':', 'recepcion',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label primeral')); ?>
								<div class="col-sm-3 col-md-3 col-lg-3 input-field">
								<?php echo form_input(array(
									'class'=>'form-control form-inps',
									'name'=>'recepcion[sales_receipt]',
									'id'=>'recepcion',
									'maxlength'=>'5',
									'value'=>$sunat_num['recepcion']));?>
								</div>
								<?php echo form_label(lang('credit_note_invoice').':', 'notacredito_factura',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label primeral')); ?>
								<div class="col-sm-3 col-md-3 col-lg-3 input-field">
								<?php echo form_input(array(
									'class'=>'form-control form-inps',
									'name'=>'notacredito_factura[credit_note_invoice]',
									'id'=>'notacredito_factura',
									'maxlength'=>'5',
									'value'=>$sunat_num['notacredito_factura']));?>
								</div>
						</div>
						<div class="form-group">	
								<?php echo form_label(lang('debit_note_bill').':', 'notadebito_boleta',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label primeral')); ?>
								<div class="col-sm-3 col-md-3 col-lg-3 input-field">
								<?php echo form_input(array(
									'class'=>'form-control form-inps',
									'name'=>'notadebito_boleta[debit_note_bill]',
									'id'=>'notadebito_boleta',
									'maxlength'=>'5',
									'value'=>$sunat_num['notadebito_boleta']));?>
								</div>
								<?php echo form_label(lang('debit_note_invoice').':', 'notadebito_factura',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label primeral')); ?>
								<div class="col-sm-3 col-md-3 col-lg-3 input-field">
								<?php echo form_input(array(
									'class'=>'form-control form-inps',
									'name'=>'notadebito_factura[debit_note_invoice]',
									'id'=>'notadebito_factura',
									'maxlength'=>'5',
									'value'=>$sunat_num['notadebito_factura']));?>
								</div>
						</div>
						<div class="form-group">	
								<?php echo form_label(lang('credit_note_bill').':', 'notacredito_boleta',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label primeral')); ?>
								<div class="col-sm-3 col-md-3 col-lg-3 input-field">
								<?php echo form_input(array(
									'class'=>'form-control form-inps',
									'name'=>'notacredito_boleta[credit_note_bill]',
									'id'=>'notacredito_boleta',
									'maxlength'=>'5',
									'value'=>$sunat_num['notacredito_boleta']));?>
								</div>

								<?php echo form_label(lang('guia_remision').':', 'guia_remision',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label primeral')); ?>
								<div class="col-sm-3 col-md-3 col-lg-3 input-field">
								<?php echo form_input(array(
									'class'=>'form-control form-inps',
									'name'=>'guia_remision[guia_remision]',
									'id'=>'guia_remision',
									'maxlength'=>'5',
									'value'=>$sunat_num['guia_remision']));?>
								</div>
