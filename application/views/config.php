		...
		<div class="col-md-12">
			<div class="panel panel-piluku">
				...
				<div class="panel-body">
					...
					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_company')) ?>">	
						<?php echo form_label(lang('ruc_company').':', 'ruc_company',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label required')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10 input-field">
						<?php echo form_input(array(
							'class'=>'form-control form-inps',
							'name'=>'ruc_company',
							'id'=>'ruc_company',
							'maxlength'=>'11',
							'value'=>$this->config->item('ruc_company')));?>
						</div>
					</div>

					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_company')) ?>">	
						<?php echo form_label(lang('common_active_invoice').':', 'active_facturacion',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10">
						<?php echo form_checkbox(array(
							'name'=>'active_facturacion',
							'id'=>'active_facturacion',
							'value'=>'active_facturacion',
							'checked'=>$this->config->item('active_facturacion')));?>
							<label for="active_facturacion"><span></span></label>
						</div>
					</div>
					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_company')) ?>">	
						<?php echo form_label(lang('common_route_base').':', 'ruta_sunat',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10 input-field">
						<?php echo form_input(array(
							'class'=>'form-control form-inps',
							'name'=>'ruta_sunat',
							'id'=>'ruta_sunat',
							'value'=>$this->config->item('ruta_sunat')));?>
						</div>
					</div>
					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_company')) ?>">	
						<?php echo form_label('Token:', 'token',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10 input-field">
						<?php echo form_input(array(
							'class'=>'form-control form-inps',
							'name'=>'token',
							'id'=>'token',
							'value'=>$this->config->item('token')));?>
						</div>
					</div>
					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_company')) ?>">	
						<?php echo form_label('Probar conexion:', 'token',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10 input-field">
							<button type="button" id="btnPruebaSunar" class="btn btn-lg  btn-warning"><span id="sunat_button_icon" class="glyphicon glyphicon-refresh"></span></button>
							<label id="mensajePrueba"></label>
						</div>
					</div>
				</div>
			</div>	
					...
					<?php echo form_label(lang('config_currency_exchange_rates').':', '',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
						...
						<table id="currency_exchange_rates" class="table">
							...
							<?php foreach($currency_exchange_rates->result() as $currency_exchange_rate) { ?>
								...
								<tr>
									...
									<?php if ($currency_exchange_rate->currency_code_to=='USD'){ ?>
										<td><input style="display: nones" type="text" name="currency_exchange_rates_rate[]" class="form-control" value="<?php echo H(to_currency_no_money($one_dolar,10)); ?>" /><input style="" type="text" name="" class="form-control" value="<?php echo $tipo_cambio->venta ?>" /></td>
									<?php }else{ ?>
						...
						<a href="javascript:void(0);" id="add_exchange_rate"><?php echo lang('config_add_currency_exchange_rate'); ?></a>
							<div class="pull-right">
								<?php  if ($tipo_cambio!=null) { ?>
								<font style="font-weight: bold;font-size: 13px;">Tipo de cambio fecha : <?php echo $tipo_cambio->fecha ?>, compra : <?php echo $tipo_cambio->compra ?>, venta: <?php echo $tipo_cambio->venta ?></font>
								<?php  }else{ ?>
									<font style="font-weight: bold;font-size: 15px;color:red;">Por favor actualizar tipo cambio manualmente</font>
								<?php } ?>
							</div>
						</div>
					</div>
...
<div class="row">
  <div class="col-sm-2 col-md-2">
    <div class="thumbnail">
      <img src="http://localhost/phppos/uploads/qr.png" alt="...">
  ...
  <div class="col-sm-2 col-md-2">
		...
		<div class="col-md-12">
			<div class="panel panel-piluku">
				...
				<div class="panel-body">
					...
					<!-- Order Purchase Return Policy -->
					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_receipt')) ?>">	
					<?php echo form_label(lang('common_cancel_policy').':', 'cancel_policy',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label required')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10">
						<?php echo form_textarea(array(
							'name'=>'cancel_policy',
							'id'=>'cancel_policy',
							...
							'rows'=>'4',
							'cols'=>'30',
							'value'=>$this->config->item('cancel_policy')));?>
						</div>
					</div>

					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_receipt')) ?>">	
					<?php echo form_label(lang('common_announcement_oc').':', 'announcement_oc',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10">
						<?php echo form_textarea(array(
							'name'=>'announcement_oc',
							'id'=>'announcement_oc',
							'class'=>'form-control text-area',
							'rows'=>'4',
							'cols'=>'30',
							'value'=>$this->config->item('announcement_oc')));?>
						</div>
					</div>
     ...
     <div class="col-md-12">
            ...
            <div class="form-group" data-keyword="<?php echo H(lang('config_keyword_ecommerce')) ?>">	
		                   ...
		                   <li class="list-group-item" data-value="import_shipping_classes_into_phppos" data-color="success"><?php echo lang('config_import_shipping_classes_into_phppos'); ?></li>
											 ...
											 <li class="list-group-item" data-requires='["import_ecommerce_tags_into_phppos", "import_ecommerce_categories_into_phppos","import_ecommerce_attributes_into_phppos","sync_inventory_changes","import_tax_classes_into_phppos","import_shipping_classes_into_phppos"]' data-value="import_ecommerce_items_into_phppos" data-color="success"><?php echo lang('config_import_ecommerce_items_into_phppos'); ?></li>
		                   ...
		                   <li class="list-group-item" data-value="export_tax_classes_into_phppos" data-color="success"><?php echo lang('config_export_tax_classes_into_phppos'); ?></li>
											 <li class="list-group-item" data-requires='["export_phppos_tags_to_ecommerce", "export_phppos_categories_to_ecommerce","export_phppos_attributes_to_ecommerce","export_tax_classes_into_phppos"]' data-value="export_phppos_items_to_ecommerce" data-color="success"><?php echo lang('config_export_phppos_items_to_ecommerce'); ?></li>
								    </ul>
								</div>
						</div>
    ...
    <?php
      ...
      <div class="col-md-12 woo_settings ecom_settings <?php echo $hidden_class; ?>">
							...
							<?php echo form_label(lang('config_qb_sync_operations').':', 'qb_sync_operations',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
								<div class="col-sm-9 col-md-9 col-lg-10 qb_sync_operations">
								  	<ul id="check-list-box" data-name="qb_sync_operations[]" class="list-group checked-list-box">
											 <li class="list-group-item" data-value="import_quickbooks_items_into_phppos" data-color="success"><?php echo lang('config_import_quickbooks_items_into_phppos'); ?></li>
											 <li class="list-group-item" data-value="import_customers_into_phppos" data-color="success"><?php echo lang('config_import_customers_into_phppos'); ?></li>
											 <li class="list-group-item" data-value="import_suppliers_into_phppos" data-color="success"><?php echo lang('config_import_suppliers_into_phppos'); ?></li>
											 <li class="list-group-item" data-value="import_employees_into_phppos" data-color="success"><?php echo lang('config_import_employees_into_phppos'); ?></li>
											 <li class="list-group-item" data-value="export_phppos_items_to_quickbooks" data-color="success"><?php echo lang('config_export_phppos_items_to_quickbooks'); ?></li>
											 <li class="list-group-item" data-value="sync_inventory_changes_qb" data-color="success"><?php echo lang('config_sync_inventory_changes_qb'); ?></li>
											 <li class="list-group-item" data-value="export_customers_to_quickbooks" data-color="success"><?php echo lang('config_export_customers_to_quickbooks'); ?></li>
											 <li class="list-group-item" data-value="export_suppliers_to_quickbooks" data-color="success"><?php echo lang('config_export_suppliers_to_quickbooks'); ?></li>
											 <li class="list-group-item" data-value="export_employees_to_quickbooks" data-color="success"><?php echo lang('config_export_employees_to_quickbooks'); ?></li>
											 <li class="list-group-item" data-value="export_sales_to_quickbooks" data-color="success"><?php echo lang('config_export_sales_to_quickbooks'); ?></li>
											 <li class="list-group-item" data-value="export_receivings_to_quickbooks" data-color="success"><?php echo lang('config_export_receivings_to_quickbooks'); ?></li>
											 <li class="list-group-item" data-value="export_expenses_to_quickbooks" data-color="success"><?php echo lang('config_export_expenses_to_quickbooks'); ?></li>
								    </ul>
								</div>
						  </div>
		...
		<!-- Chart of account Area-->
		<?php if (($this->config->item('quickbooks_access_token')) && (isset($arrayAccountsQb['all'])))  { ?>
		<div class="col-md-12">
			<div class="panel panel-piluku">
				<div class="panel-heading">
					<?php echo create_section(lang('config_chart_of_accounts'))  ?>
				</div>
				<div class="panel-body">
						<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_chart_of_account')) ?>">	
							<?php echo form_label(lang('config_default_refund_credit_account_name').':', 'refund_credit_account',array('class'=>'col-sm-3 col-lg-2 control-label ')); ?>
							<div class="col-sm-9 col-lg-10">
								<?php echo form_dropdown('refund_credit_account', $arrayAccountsQb['Bank'],$this->config->item('refund_credit_account'), 'class="form-control qb-account" id="refund_credit_account"');
								?>
								<label for="refund_credit_account"><span></span></label>
							</div>
						</div>

						<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_chart_of_account')) ?>">	
							<?php echo form_label(lang('config_default_refund_cash_account_name').':', 'refund_cash_account',array('class'=>'col-sm-3 col-lg-2 control-label ')); ?>
							<div class="col-sm-9 col-lg-10">
								<?php echo form_dropdown('refund_cash_account', $arrayAccountsQb['Bank'],$this->config->item('refund_cash_account'), 'class="form-control qb-account" id="refund_cash_account"');
								?>
								<label for="refund_cash_account"><span></span></label>
							</div>
						</div>

						<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_chart_of_account')) ?>">	
							<?php echo form_label(lang('config_default_refund_debit_card_account_name').':', 'refund_debit_card_account',array('class'=>'col-sm-3 col-lg-2 control-label ')); ?>
							<div class="col-sm-9 col-lg-10">
								<?php echo form_dropdown('refund_debit_card_account', $arrayAccountsQb['Bank'],$this->config->item('refund_debit_card_account'), 'class="form-control qb-account" id="refund_debit_card_account"');
								?>
								<label for="refund_debit_card_account"><span></span></label>
							</div>
						</div>

						<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_chart_of_account')) ?>">	
							<?php echo form_label(lang('config_default_refund_credit_card_account_name').':', 'refund_credit_card_account',array('class'=>'col-sm-3 col-lg-2 control-label ')); ?>
							<div class="col-sm-9 col-lg-10">
								<?php echo form_dropdown('refund_credit_card_account', $arrayAccountsQb['bank_and_credit_card'],$this->config->item('refund_credit_card_account'), 'class="form-control qb-account" id="refund_credit_card_account"');
								?>
								<label for="refund_credit_card_account"><span></span></label>
							</div>
						</div>

						<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_chart_of_account')) ?>">	
							<?php echo form_label(lang('config_default_refund_check_account_name').':', 'refund_check_account',array('class'=>'col-sm-3 col-lg-2 control-label ')); ?>
							<div class="col-sm-9 col-lg-10">
								<?php echo form_dropdown('refund_check_account', $arrayAccountsQb['Bank'],$this->config->item('refund_check_account'), 'class="form-control qb-account" id="refund_check_account"');
								?>
								<label for="refund_check_account"><span></span></label>
							</div>
						</div>

						<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_chart_of_account')) ?>">	
							<?php echo form_label(lang('config_default_refund_deposit_account_name').':', 'refund_deposit_account',array('class'=>'col-sm-3 col-lg-2 control-label ')); ?>
							<div class="col-sm-9 col-lg-10">
								<?php echo form_dropdown('refund_deposit_account', $arrayAccountsQb['Bank'],$this->config->item('refund_deposit_account'), 'class="form-control qb-account" id="refund_deposit_account"');
								?>
								<label for="refund_deposit_account"><span></span></label>
							</div>
						</div>
						<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_chart_of_account')) ?>">	
							<?php echo form_label(lang('config_default_expense_account_name').':', 'expense_account',array('class'=>'col-sm-3 col-lg-2 control-label ')); ?>
							<div class="col-sm-9 col-lg-10">
								<?php echo form_dropdown('expense_account', $arrayAccountsQb['Expense'],$this->config->item('expense_account'), 'class="form-control qb-account" id="expense_account"');
								?>
								<label for="expense_account"><span></span></label>
							</div>
						</div>
						<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_chart_of_account')) ?>">	
							<?php echo form_label(lang('config_default_expense_bank_credit_account_name').':', 'expense_bank_credit_account',array('class'=>'col-sm-3 col-lg-2 control-label ')); ?>
							<div class="col-sm-9 col-lg-10">
								<?php echo form_dropdown('expense_bank_credit_account', $arrayAccountsQb['bank_and_credit_card'],$this->config->item('expense_bank_credit_account'), 'class="form-control qb-account" id="expense_bank_credit_account"');
								?>
								<label for="expense_bank_credit_account"><span></span></label>
							</div>
						</div>
						<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_chart_of_account')) ?>">	
							<?php echo form_label(lang('config_default_commission_credit_account_name').':', 'commission_credit_account',array('class'=>'col-sm-3 col-lg-2 control-label ')); ?>
							<div class="col-sm-9 col-lg-10">
								<?php echo form_dropdown('commission_credit_account', $arrayAccountsQb['Other Current Liability'],$this->config->item('commission_credit_account'), 'class="form-control qb-account" id="commission_credit_account"');
								?>
								<label for="commission_credit_account"><span></span></label>
							</div>
						</div>
						<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_chart_of_account')) ?>">	
							<?php echo form_label(lang('config_default_commission_debit_account_name').':', 'commission_debit_account',array('class'=>'col-sm-3 col-lg-2 control-label ')); ?>
							<div class="col-sm-9 col-lg-10">
								<?php echo form_dropdown('commission_debit_account', $arrayAccountsQb['Bank'],$this->config->item('commission_debit_account'), 'class="form-control qb-account" id="commission_debit_account"');
								?>
								<label for="commission_debit_account"><span></span></label>
							</div>
						</div>
						<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_chart_of_account')) ?>">	
							<?php echo form_label(lang('config_default_house_account_name').':', 'store_account',array('class'=>'col-sm-3 col-lg-2 control-label ')); ?>
							<div class="col-sm-9 col-lg-10">
								<?php echo form_dropdown('store_account', $arrayAccountsQb['Other Current Asset'],$this->config->item('store_account'), 'class="form-control qb-account" id="store_account"');
								?>
								<label for="store_account"><span></span></label>
							</div>
						</div>
						
						<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_chart_of_account')) ?>">	
							<?php echo form_label(lang('config_default_revenue_account_for_item').':', 'revenue_account_id',array('class'=>'col-sm-3 col-lg-2 control-label ')); ?>
							<div class="col-sm-9 col-lg-10">
								<?php echo form_dropdown('revenue_account_id', $arrayAccountsQb['Income'],$this->config->item('revenue_account_id') ? $this->config->item('revenue_account_id') : array_search('Sales of Product Income',$arrayAccountsQb['Income']), 'class="form-control qb-account" id="revenue_account_id"');
								?>
								<label for="revenue_account_id"><span></span></label>
							</div>
						</div>

						<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_chart_of_account')) ?>">	
							<?php echo form_label(lang('config_default_asset_account_for_item').':', 'asset_account_id',array('class'=>'col-sm-3 col-lg-2 control-label ')); ?>
							<div class="col-sm-9 col-lg-10">
								<?php echo form_dropdown('asset_account_id', $arrayAccountsQb['Other Current Asset'],$this->config->item('asset_account_id'), 'class="form-control qb-account" id="asset_account_id"');
								?>
								<label for="asset_account_id"><span></span></label>
							</div>
						</div>

						<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_chart_of_account')) ?>">	
							<?php echo form_label(lang('config_default_expense_account_for_item').':', 'expense_account_id',array('class'=>'col-sm-3 col-lg-2 control-label ')); ?>
							<div class="col-sm-9 col-lg-10">
								<?php echo form_dropdown('expense_account_id', $arrayAccountsQb['Cost of Goods Sold'],$this->config->item('expense_account_id'), 'class="form-control qb-account" id="expense_account_id"');
								?>
								<label for="expense_account_id"><span></span></label>
							</div>
						</div>

						
						<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_chart_of_account')) ?>">	
							<?php echo form_label(lang('config_default_customer_id').':', 'default_customer_id',array('class'=>'col-sm-3 col-lg-2 control-label ')); ?>
							<div class="col-sm-9 col-lg-10">
								<?php echo form_dropdown('default_customer_id', $all_customer_data,$this->config->item('default_customer_id'), 'class="form-control qb-account" id="default_customer_id"');
								?>
								<label for="default_customer_id"><span></span></label>
							</div>
						</div>

						<?php
						if($this->config->item('default_country_id') != US_CODE) {
						?>
							<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_chart_of_account')) ?>">	
								<?php echo form_label(lang('config_default_tax').':', 'default_tax_id',array('class'=>'col-sm-3 col-lg-2 control-label ')); ?>
								<div class="col-sm-9 col-lg-10">
									<?php echo form_dropdown('default_tax_id', $taxArray,$this->config->item('default_tax_id'), 'class="form-control qb-account" id="default_tax_id"');
									?>
									<label for="default_tax_id"><span></span></label>
								</div>
							</div>

							<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_chart_of_account')) ?>">	
								<?php echo form_label(lang('config_default_store_account_tax').':', 'default_store_account_tax_id',array('class'=>'col-sm-3 col-lg-2 control-label ')); ?>
								<div class="col-sm-9 col-lg-10">
									<?php echo form_dropdown('default_store_account_tax_id', $taxArray,$this->config->item('default_store_account_tax_id'), 'class="form-control qb-account" id="default_store_account_tax_id"');
									?>
									<label for="default_store_account_tax_id"><span></span></label>
								</div>
							</div>
						<?php
						}
		...
		$.getJSON($(this).attr('href'), function(update_available) 
		{
			...
			if(update_available)
			{
				bootbox.confirm(<?php echo json_encode(lang('common_update_available')); ?>, function(response)
				{
					if (response)
					{
						window.location="http://bitzua.com";
					}
				});
			}
			else
...
/**
 * Esto es mi agredado para realizar la  prueba de conexion con sunat
 * mensajePrueba
 */
$("#btnPruebaSunar").click(function(){
	$('#sunat_button_icon').toggleClass("glyphicon-refresh-animate", true);
	$.ajax({
		type: "POST",
		url: SITE_URL+"/config/probarSunat",
		data: {},
		dataType: "json",
		success: function (response) {
			if(response.status){
				$("#mensajePrueba").text(response.message);
				$('#sunat_button_icon').toggleClass("glyphicon-refresh-animate", false);
			}else{
				$("#mensajePrueba").text(response.message);
				$('#sunat_button_icon').toggleClass("glyphicon-refresh-animate", false);
			}
