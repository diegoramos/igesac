	...
	<div class="col-md-12">
		<div class="panel">
			<h4 class="text-center">
				...
				<font style="font-weight: bold;font-size: 13px;">Tipo de cambio para Hoy: <?php echo date('d/m/Y',strtotime($tipo_cambio->fecha)) ?>, Compra: <?php echo $tipo_cambio->compra ?> - Venta: <?php echo $tipo_cambio->venta ?></font>
				<?php  }else{ ?>
