				...
				<div class="panel-body nopadding table_holder table-responsive">
						...
						<thead>
							<tr>
								...
								<th><?php echo lang('receivings_op'); ?></th>
								<th><?php echo lang('common_email_receipt'); ?></th>
								<th><?php echo lang('common_void_delete'); ?></th>
							</tr>
						</thead>
						<tbody>
					<?php
					...
					?>
						<tr>
							<td><!-- RECV--> <?php echo $suspended_receiving['serie'];?></td>
							...
							<td>
								<?php 
								echo form_open('receivings/receipt_op/'.$suspended_receiving['receiving_id'], array('method'=>'get', 'class' => 'form_receipt_suspended_recv'));
								?>
								<input type="submit" name="submit" value="<?php echo lang('common_recp_op'); ?>" id="submit_receipt" class="btn btn-primary">
								<?php echo form_close(); ?>
							</td>
							...
							if ($suspended_receiving['email']) 
							{
								...
								?>
									<input type="submit" name="submit" value="<?php echo $suspended_receiving['is_po'] ? lang('receivings_email_po') : lang('receivings_email_po'); ?>" id="submit_receipt" class="btn btn-primary">
								<?php echo form_close(); ?>
							<?php } ?>
							...
							<td>
								...
								echo form_hidden('suspended_receiving_id', $suspended_receiving['receiving_id']);
								?>
								<input type="submit" name="submitf" value="<?php echo lang('common_void_delete'); ?>" id="submit_delete" class="btn btn-danger">
								<?php echo form_close(); ?>
							</td>
						</tr>
					<?php
