		...
		<div class="col-md-6">
			<span class="hidden-print search no-left-border">
				<ul class="list-inline print-buttons">
					...
					if ((empty($deleted) || (!$deleted)) && empty($currentReceivingAccoutingId)) { ?>
					<?php
		...
		<div class="col-md-6">	
			<div class="buttons-list">
				<div class="pull-right-btn">
					<ul class="list-inline print-buttons">
						<li>
							<button class="btn btn-primary btn-lg hidden-print" id="print_button" onclick="window.open('<?php echo site_url("receivings/receipt_op_pdf/$receiving_id_raw"); ?>', 'blank');"> <?php echo lang('common_download_pdf'); ?> </button>
						</li>
						<li>
		...
		<section class="invoice">
			...
			<div class="panel panel-piluku">
				<div class="panel-body panel-pad">
					...
					<div class="row">
			            <div class="col-md-12 col-sm-12 col-xs-12">
			                <div class="invoice-footer-value" style="padding-right:10px;padding-left:10px;width:100%;text-align:left;">
								<?php
						...
						<tr>
							<td class="one-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;">
								<table width="100%" style="border-spacing:0;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;color:#555555;font-size:13px;">
									...
									<tr>
										<td class="inner contents" style="padding-top:0px;padding-bottom:0px;padding-right:10px;padding-left:10px;width:100%;text-align:left;" >
											<p style="Margin:0;font-size:13px;Margin-bottom:5px;" >
