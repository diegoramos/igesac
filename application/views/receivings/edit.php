...
$receiving_rec_info = $this->Receiving->get_info($receiving_info['receiving_id'])->result_array();
if (($receiving_rec_info) && ($receiving_rec_info['0'])) {
	$currentReceivingAccoutingId = $receiving_rec_info['0']['accounting_id'];
}
?>
	...
	<div class="col-md-12">
		<div class="panel piluku-panel">
			<div class="panel-heading">
				<h4 class=""><?php echo lang('receivings_register')." - ".lang('receivings_edit_receiving'); ?> <!-- RECV--> <?php echo $serie;//$receiving_info['receiving_id']; ?>	</h4>
			</div>
					...
					<?php echo form_open("receivings/save/".$receiving_info['receiving_id'],array('id'=>'receivings_edit_form','class'=>'form-horizontal')); ?>
						...
						<?php echo form_label(lang('receivings_receipt').':', 'receipt',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
							<div class="col-sm-9 col-md-9 col-lg-10 sale-s">
								<?php echo anchor('receivings/receipt/'.$receiving_info['receiving_id'], /*'RECV '.$receiving_info['receiving_id']*/$serie, array('target' => '_blank'));?>
							</div>
						</div>
