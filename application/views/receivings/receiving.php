<a tabindex="-1" href="#" class="dismissfullscreen <?php echo !$fullscreen ? 'hidden' : ''; ?>"><i class="ion-close-circled"></i></a>
	<?php if($cart->get_previous_receipt_id()) { ?>
		<div class="alert alert-danger">
			<?php echo lang('receivings_editing_recv'); ?> <strong><?php echo (($serie!='') ? $serie : $cart->receiving_id); ?></strong>
		</div>
	<?php } ?>
...
<div class="row register">
	...
	<!-- Receive  Top Buttons  -->
		...
		<li class="sub-total list-group-item receivings">
			...
			<span class="value"><?php //echo to_currency($subtotal); ?>
...
$(document).ready(function()
{
   ...
   $("#change_cart_date").on("dp.change", function(e) {
	...
	{
		var rate = $(this).val();
		$.post('<?php echo site_url("receivings/exchange_to");?>',{'rate': rate}, function(response)
		{
			$("#register_container").html(response);
		});
	});
