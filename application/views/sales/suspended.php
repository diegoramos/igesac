		...
		<div class="row manage-table">
			<div class="panel panel-piluku">
				...
				<thead>	<tr>
					...
					<th><?php echo lang('common_look_quot'); ?></th>
				...
				?>
					<tr>
						<td><?php echo $suspended_sale['serie'];//($this->config->item('sale_prefix') ? $this->config->item('sale_prefix') : 'POS' ). ' '.$suspended_sale['sale_id'];?></td>
						...
						<td><?php echo no_money($suspended_sale['total_quantity_purchased']);?></td>
						...
						<td>
							<?php 
							echo form_open('sales/quotation/'.$suspended_sale['sale_id'], array('method'=>'get', 'class' => 'form_receipt_suspended_sale'));
							?>
							<input type="submit" name="submit" value="<?php echo lang('common_quotes'); ?>" id="submit_receipt" class="btn btn-primary" />
							<?php echo form_close(); ?>
						</td>
						<td>
						<?php
						if ($suspended_sale['email']) 
						{
							...
							?>
								<input type="submit" name="submit" value="<?php echo lang('common_send'); ?>" id="submit_receipt" class="btn btn-primary" />
							<?php echo form_close(); ?>
						<?php } ?>
						...
						<?php
							...
							echo form_hidden('suspended_sale_id', $suspended_sale['sale_id']);
							?>
							<input type="submit" name="submitf" value="<?php echo lang('common_cancel'); ?>" id="submit_delete" class="btn btn-danger">
							<?php echo form_close(); ?>
						</td>
						<?php } ?>
					</tr>
