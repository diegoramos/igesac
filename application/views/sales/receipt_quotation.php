			...
			<div class="buttons-list">
				<div class="pull-right-btn">
					<ul class="list-inline print-buttons">
						...
						<li>
							<button class="btn btn-primary btn-lg hidden-print" id="print_button" onclick="window.open('<?php echo site_url("sales/quotation_pdf/$sale_id_raw"); ?>', 'blank');" > <?php echo lang('common_download_pdf'); ?> </button>		
						</li>
						<li>
			...
			<table class="outer" align="center" style="border-spacing:0;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;color:#555555;font-size:13px;Margin:0 auto;width:100%;max-width:100%;" >
				...
				<tr>
					<td class="two-column" style="padding-top:10px;padding-bottom:0;padding-right:0;padding-left:0;text-align:center;font-size:0;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#DCE0E6;" >
						...
						<![endif]-->
						<div class="column" style="width:30%;display:inline-block;vertical-align:top;" >
							<table width="100%" style="border-spacing:0;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;color:#555555;font-size:13px;" >
								<tr>
						...
						<![endif]-->
						<div class="column border-left" style="border-left-width:1px;border-left-style:solid;border-left-color:#DCE0E6;width:40%;display:inline-block;vertical-align:top;" >
							<table width="100%" style="border-spacing:0;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;color:#555555;font-size:13px;" >
								<tr>
									<td class="inner" style="padding-top:10px;padding-bottom:10px;padding-right:10px;padding-left:10px;" >
										<table class="contents" style="border-spacing:0;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;color:#555555;width:100%;font-size:13px;text-align:left;" >
				...
				<tr>
					<td class="one-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;" >
						<table width="100%" style="border-spacing:0;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;color:#555555;font-size:13px;" >
							<tr>
								<td class="inner no-padding" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" >
									<table width="100%" class="items-table" style="border-spacing:0;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;color:#555555;font-size:13px;padding-top:5px !important;" >
										...
										<?php } ?>
										<!-- Aqui estaba campos personalizados Sales -->
			...
			<table width="100%" style="border-spacing:0;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;color:#555555;font-size:13px;" >
				<tr>
					<td style="text-align: center;">
						<img style="width:70%;" src="<?php echo base_url('assets/img/msa.png'); ?>" />
					</td>
					<td style="text-align: center;">
						<img style="width:70%;" src="<?php echo base_url('assets/img/kimberly.png'); ?>" />
					</td>
					<td style="text-align: center;">
						<img style="width:70%;" src="<?php echo base_url('assets/img/3m.png'); ?>" />
					</td>
					<td style="text-align: center;">
						<img style="width:70%;" src="<?php echo base_url('assets/img/regeltex.jpg'); ?>" />
					</td>
					<td style="text-align: center;">
						<img style="width:70%;" src="<?php echo base_url('assets/img/dupont.png'); ?>" />
					</td>
					<td style="text-align: center;">
						<img style="width:70%;" src="<?php echo base_url('assets/img/ansell.png'); ?>" />
					</td>
					<td style="text-align: center;">
						<img style="width:70%;" src="<?php echo base_url('assets/img/steelpro.jpg'); ?>" />
					</td>
				</tr>
			</table>
	  </section>
