			    ...
			    <div class="row">
			        ...
			        <div class="col-md-4 col-sm-4 col-xs-12">
			            <ul class="list-unstyled invoice-detail" style="margin-bottom:2px;">
			            	<li><strong>R.U.C <?php echo $ruc_company; ?></strong></li>
							<li>
								<?php if ($receipt_title) {?>
								 <strong><?php echo H($receipt_title); ?><?php echo ($total) < 0 ? ' ('.lang('sales_return').')': '';?></strong>
								 <?php } ?>
							</li>
							<li><strong><?php echo lang('common_sale_id').": "; ?><?php echo H($sale_id); ?></strong></li>
							<li><strong><?php echo H($transaction_time) ?></strong></li>
			        ...
			        <div class="col-md-12 col-sm-12 col-xs-12">
			          ...
			          <?php if(isset($delivery_person_info)) { ?>
				        <ul class="list-unstyled invoice-address" style="margin-bottom:10px;">
									...
									<li class="invoice-to"><strong><?php echo lang('deliveries_shipping_address');?>:</strong></li>
									<li><strong><?php echo lang('common_name').": ".H($delivery_person_info['first_name'].' '.$delivery_person_info['last_name']); ?></strong></li>
									
									<?php if(!empty($delivery_person_info['address_1']) || !empty($delivery_person_info['address_2'])){ ?><li><strong><?php echo lang('common_address'); ?> : <?php echo H($delivery_person_info['address_1']. ' '.$delivery_person_info['address_2']); ?></strong></li><?php } ?>
									<?php if (!empty($delivery_person_info['city'])) { echo '<li><strong>'.H($delivery_person_info['city'].' '.$delivery_person_info['state'].', '.$delivery_person_info['zip']).'</strong></li>';} ?>
									<?php if (!empty($delivery_person_info['country'])) { echo '<li><strong>'.H($delivery_person_info['country']).'</strong></li>';} ?>			
									<?php if(!empty($delivery_person_info['phone_number'])){ ?><li><strong><?php echo lang('common_phone_number'); ?> : <?php echo H($delivery_person_info['phone_number']); ?></strong></li><?php } ?>
									<?php if(!empty($delivery_person_info['email'])){ ?><li><strong><?php echo lang('common_email'); ?> : <?php echo H($delivery_person_info['email']); ?></strong></li><?php } ?>
								...
								<?php if(!empty($delivery_info['estimated_delivery_or_pickup_date']) || !empty($delivery_info['tracking_number']) ||  !empty($delivery_info['comment'])) {?>
									<ul class="list-unstyled invoice-address" style="margin-bottom:10px;">
										<li class="invoice-to"><strong><?php echo lang('deliveries_delivery_information');?>:</strong></li>
										<?php if(!empty($delivery_info['estimated_delivery_or_pickup_date'])){ ?><li><strong><?php echo lang('deliveries_estimated_delivery_or_pickup_date'); ?> : <?php echo date(get_date_format().' '.get_time_format(),strtotime($delivery_info['estimated_delivery_or_pickup_date'])); ?></strong></li><?php } ?>
										<?php if(!empty($delivery_info['tracking_number'])){ ?><li><strong><?php echo lang('deliveries_tracking_number'); ?> : <?php echo H($delivery_info['tracking_number']); ?></strong></li><?php } ?>
										<?php if(!empty($delivery_info['comment'])){ ?><li><strong><?php echo lang('common_comment'); ?> : <?php echo H($delivery_info['comment']); ?></strong></li><?php } ?>
			    ...
			    <div class="invoice-table">
			        <div class="row">
			            <div class="<?php echo $this->config->item('wide_printer_receipt_format') ? 'col-md-'.$x_col . ' col-sm-' .$x_col . ' col-xs-'.$x_col : 'col-md-12 col-sm-12 col-xs-12' ?>">
			                <div class="invoice-head item-name"><?php echo lang('common_description'); ?></div>
			            </div>
			    ...
			    <div class="invoice-footer gift_receipt_element">
					...
					if ($this->config->item('show_total_discount_on_receipt')) { ?>
						<div class="row">
				            ...
				            <div class="col-md-2 col-sm-2 col-xs-4">
				                <div class="invoice-footer-value invoice-total"><?php echo to_currency($cart->get_total_discount()*$exchange_rate); ?></div>
				            </div>
				        </div>
			    ...
			    <div class="row">
			        <div class="col-md-12 col-sm-12 col-xs-12">
				        ...
				        <div class="invoice-policy">
				          ...
				          <p><strong>SON:</strong> <?php echo num_to_letras($total,"Y",letra_modena($exchange_name)); ?></p>
				          <img src="<?php echo base_url() ?>uploads/qr.png" lt="QR-code" width="111" height="111"/>
				          <p>
				            Representación impresa de la Factura Electronica Autorizado mediante Resolución N° 018-005-000564 <br> Consulta: https://www.sunat.gob.pe/ol-ti-itconsultaunificadalibre/consultaUnificadaLibre/consulta
				          </p>
				        </div>

			            <div class="invoice-policy" id="invoice-policy-return" style="display: none;">
