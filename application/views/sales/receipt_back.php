							...
							<tr>
								<td style="border: 0px solid black; border-radius: 25px" >
									<table width="100%">
										<tbody>												
											<tr>
												<td style="padding-top: 1px;padding-left: 10px;" width="40%"><strong><font color="black">Señores:</font></strong></td>
												<td><font color="black"><?php if (!$this->config->item('remove_customer_name_from_receipt')) { ?>
												<?php echo explode('-',H($customer))[0]; ?><?php } ?></font></td>
											</tr>
											<tr>
												<td style="padding-top: 1px;padding-left: 10px;"><strong><font color="black" >Fecha de emisión:</font></strong></td>
