	...
	<div class="row" id="form">
		...
		<div class="panel panel-piluku">
			...
			<div class="panel-body">
				...
				<div class="form-group">
				<?php echo form_label(lang('employees_isadmin').':', 'isadmin',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
					<div class="col-sm-9 col-md-9 col-lg-10">
						<?php
						echo	form_checkbox(array(
							'name' => 'isadmin',
							'id' => 'isadmin',
							'value' => 1,
							'checked' => $person_info->isadmin,
							));
							echo '<label for="isadmin"><span></span></label>';;
						?>
					</div>
				</div>
			</div>
