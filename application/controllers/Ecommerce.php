      ...
      public function cron($base_url='', $db_override = '')
      {
				...
				{	
					...
					if( $platform_model != "" )
					{
						...
						$valid = array("import_ecommerce_tags_into_phppos", "import_ecommerce_categories_into_phppos", "import_ecommerce_items_into_phppos","import_ecommerce_attributes_into_phppos", "import_tax_classes_into_phppos", "import_shipping_classes_into_phppos","sync_inventory_changes", "import_ecommerce_orders_into_phppos","export_phppos_tags_to_ecommerce", "export_phppos_categories_to_ecommerce", "export_phppos_attributes_to_ecommerce","export_tax_classes_into_phppos","export_phppos_items_to_ecommerce");
