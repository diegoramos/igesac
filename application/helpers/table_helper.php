...
function get_item_data_row($item,$controller)
{
	...
	if(!$params['deleted'])
	{
		...
		$table_data_row.= '<li>'. anchor($controller_name."/clone_item/$item->item_id?redirect=items", '<i class="ion-ios-browsers-outline"></i> ' . lang('common_clone') .' ' . lang('common_item'), array('class'=>' ','title'=>lang('common_clone'))).'</li>';
